function dst = IntraDecode(image, img_size , qScale,EOB,intra_mode)
...
%  Output        : dst   (decoded image)
    ...
    image_dequant = blockproc(image_dezigz,[8,8],@(block_struct) DeQuant8x8(block_struct.data,qScale,intra_mode));
