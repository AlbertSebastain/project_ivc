function [rec] = inter_recon(img,im_size,qScale,EOB)
    len = im_size(1);
    col = im_size(2);
    dim = im_size(3);
    ...
    image_dequant_y = blockproc(image_dezigz_y,[8,8],@(block_struct) DeQuant8x8(block_struct.data,qScale,"luminance"));
    image_dequant_cb = blockproc(image_dezigz_cb,[8,8],@(block_struct) DeQuant8x8(block_struct.data,qScale,"chrom"));
    image_dequant_cr = blockproc(image_dezigz_cr,[8,8],@(block_struct) DeQuant8x8(block_struct.data,qScale,"chroma"));
